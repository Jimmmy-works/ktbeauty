...
const ModalCreateProduct = ({
  ...
  return (
            ...
            <div className="w-full flex items-center gap-3 mt-[12px]">
              ...
              <span
                ...
                className="border cursor-pointer hover:border-primary rounded-[50%]
                  border-solid border-black-555 text-16px font-om
                    ...
                    return (
                      ...
                      >
                        <li className="flex  items-start gap-3">
                          -
                          <span className="text-black-333 font-osr text-sm">
                            {i}
                          </span>
                        </li>
                        <div>
    ...
    // <Drawer
    //   id={"product-handle-1"}
    //   size={modalProps?.width >= 1024 ? "large" : "default"}
    //   placement="right"
    //   title="Create Product"
    //   key={MODAL_OPTION.PRODUCT.CREATE}
    //   className="dashboard-modal"
