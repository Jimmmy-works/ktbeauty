      ...
      <div className="container ">
        <div className="flex gap-[14px] mt-[30px]">
              ...
              <div className="w-full h-full ">
                <a className="block relative pb-[100%] h-0 overflow-hidden group/zoom">
                  <ImageZoom
                    magnifierHeight="300"
                    magnifierWidth="300"
                    src={`${baseURL}${currentImg || `${images?.[0]}`}`}
                  />
                </a>
          ...
          <div className="shoppage__right w-1/2 pl-[36px]">
            ...
            <StyleRate>
              <Rate />
              <p className="shoppage__right-rating text-sm text-black-555 font-osr ">
                3.00 ratings
              </p>
            </StyleRate>
            <p className="shoppage__right-price text-[15px] text-primary font-osb">
              $110.00
            </p>
            ...
            <div className="shoppage__right-button  flex items-center  gap-2 mt-[30px]">
              ...
              h-[60px]"
              >
                <div onClick={onDecrease} className="px-[22px] cursor-pointer">
                ...
                />
                <div onClick={onIncrease} className="px-[22px] cursor-pointer">
                  <svg
            ...
            <Tab.ContentItem>
              <div className="description">
                <h3 className="font-osr text-black-555 text-[15px] leading-[24px] ">
                  ...
                  Dolores nisi, voluptatibus architecto non ratione aliquam
                  impedit commodi officiis corrupti, amet repudiandae sit rem
                  deleniti sint, esse vitae maiores! Illum maxime veritatis sunt
                  non possimus, tempore eveniet magnam hic pariatur odio?
                </h3>
        ...
        {/* <div className="tab">
          <ul className="tab__header mb-[30px] border-b border-solid border-gray-200 flex items-center justify-center ">
            <li
              className="p-[10px_20px_15px] text-grey-999 text-[16px] font-osb relative before:absolute cursor-pointer
            before:w-full before:h-[2px] before:bg-primary before:top-[calc(100%)] before:left-0 before:origin-right 
            hover:before:origin-left hover:before:scale-x-100 before:scale-x-0 before:duration-400 
            before:transition-transform hover:text-black-555 duration-400 transition-colors"
            >
              Description
            </li>
            <li
          ...
          <div className="tab__content  max-w-[750px] mx-auto">
            <Review />
          </div>
          <div className="tab__content   max-w-[750px] mx-auto">
            <div className="tab__content-pane tab-desc">
              <h3 className="font-osr text-black-555 text-[15px] leading-[24px] ">
