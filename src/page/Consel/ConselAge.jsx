...
const ConselAge = ({ onChangeConselAge, valueAge, width }) => {
  return (
    <div className="flex flex-wrap gap-y-[30px] justify-center items-center -mx-[15px] ">
      <div
        className={`xs:w-full md:w-[calc(50%-30px)] lg:w-[calc(33.33333%-30px)] mx-[15px] flex gap-3 items-center justify-center  cursor-pointer
      ...
      >
        <img srcSet={`/assets/img/bg-consel-age-2.png 1.5x`} alt="" />
      ...
      >
        ...
        <img srcSet={`/assets/img/bg-consel-age-1.png 1.5x`} alt="" />
      </div>
      <div
        className={`xs:w-full md:w-[calc(50%-30px)] lg:w-[calc(33.33333%-30px)] mx-[15px] flex gap-3 items-center justify-center  cursor-pointer
         aspect-[16/12] rounded-[20px] duration-300 transition-all hover:bg-gray-700 
