...
const ConselSex = ({ onChangeConselSex, valueSex }) => {
  return (
    <div className="flex flex-wrap gap-y-[20px] items-center -mx-[15px]">
      <div
        className={`xs:w-full md:w-[calc(50%-30px)] flex items-center justify-center h-full  mx-[15px] cursor-pointer
