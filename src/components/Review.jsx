        ...
        <div className="flex  items-start xs:gap-3 md:gap-[30px]">
          ...
          <div className="w-full md:p-[20px] md:border md:border-solid md:border-[#e5e5e5]">
            <div>
              ...
              <textarea
                className="textarea w-full font-osr text-black-333 xs:text-sm md:text-15px xs:mt-[10px] md:mt-[20px] 
                my-scrollbar md:border-none xs:border xs:border-solid xs:border-gray-200 p-[10px]"
